...
| `env_status` | — | `ok` (todas exactas) · `fallback` (alguna usó la celda de mar más cercana) · `fuera_de_rango` (lance fuera de la cobertura temporal). El estado `sin_coords` no aparece aquí: todos los lances de este dataset tienen ubicación. |
